...
CREATE TABLE categories_sub(
    cat_sub_id          INT(4)          NOT NULL AUTO_INCREMENT,
...
ALTER TABLE categories_sub ADD FOREIGN KEY(cat_id) REFERENCES categories(cat_id)    ON DELETE CASCADE  ON UPDATE CASCADE;